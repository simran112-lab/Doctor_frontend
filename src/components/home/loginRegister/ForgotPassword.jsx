...
const ForgotPassword = () => {
    ...
    const requestOtp = async (e) => {
        ...
        setOtpFlag(true);
        axios.post("https://doctor-backend-4-c22b.onrender.com/sendOtppassword", { email: forgotPasswordData.email })
            .then((response) => {
                //setOtpFlag(true);
    ...
    const submitData = async (e) => {
        ...
        axios.post("https://doctor-backend-4-c22b.onrender.com/changePassword", { email: forgotPasswordData.email, password: forgotPasswordData.password, otp: forgotPasswordData.otp })
            .then((response) => {
