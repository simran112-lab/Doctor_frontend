...
const Login = () => {
  ...
  const requestOtp = async (e) => {
    ...
    setOtpFlag(true);
    axios.post("https://doctor-backend-4-c22b.onrender.com/sendotp", { email: registrationData.email })
      .then((response) => {
        setOtpFlag(true);
  ...
  const loginUsingPassword = async (e) => {
    ...
    axios.post("https://doctor-backend-4-c22b.onrender.com/login", registrationData).
      then(response => {
  ...
  const loginUsingOTP = async (e) => {
    ...
    axios.post("https://doctor-backend-4-c22b.onrender.com/verifyOtp", registrationData)
      .then((response) => {
        if (response.data.userData.role === "admin") {
          navigate(`/admin/admindetails`);
        }
