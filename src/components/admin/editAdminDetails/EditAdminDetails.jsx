...
const EditAdminDetails = () => {
    ...
    return (
        <div className='editadmindetails'>
            <div className='editadminimage'><img className='editadminprofileimage' src={`https://doctor-backend-4-c22b.onrender.com/` + adminDetails.profile_image} alt='admin'></img></div>
