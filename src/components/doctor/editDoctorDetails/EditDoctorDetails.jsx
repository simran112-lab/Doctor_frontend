...
const EditDoctorDetails = () => {
    ...
    return (
        <div className='editdoctordetails'>
            <div className='editdoctorimage'><img className='editdoctorprofileimage' src={`https://doctor-backend-4-c22b.onrender.com/`+doctorDetails.profile_image} alt='doctor'></img></div>
